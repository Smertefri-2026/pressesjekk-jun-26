                ...
                <div className="grid gap-6 xl:grid-cols-[1fr_420px]">
                  <div>
                    <div className="flex flex-wrap items-center gap-3">
                      <span className="rounded-full bg-cyan-50 px-3 py-1 text-xs font-black uppercase tracking-[0.18em] text-cyan-700">
                  ...
                  <div className="rounded-3xl border border-cyan-200 bg-cyan-50 p-5">
                    ...
                    <div className="mt-5 grid gap-3">
                      <select
                        ...
                        className="rounded-2xl border border-cyan-200 bg-white px-4 py-4 text-sm font-bold text-slate-950 outline-none focus:border-cyan-500"
                      >
                      ...
                      <div className="grid gap-3 sm:grid-cols-2">
                        ...
                        <button
                          ...
                          disabled={savingCaseId === caseItem.id}
                          className="rounded-2xl bg-cyan-600 px-5 py-4 text-sm font-black text-white hover:bg-cyan-700 disabled:cursor-not-allowed disabled:opacity-60"
                        >
                          Kompensasjon
                        </button>
                      </div>
