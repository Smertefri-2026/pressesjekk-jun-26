                  ...
                  <form onSubmit={handleDocumentUpload} className="grid gap-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="mt-2 w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-4 text-slate-950 outline-none file:mr-4 file:rounded-xl file:border-0 file:bg-slate-950 file:px-4 file:py-2 file:text-sm file:font-black file:text-white focus:border-red-500 focus:bg-white"
                      />
                      <p className="mt-2 text-sm leading-6 text-slate-500">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="divide-y divide-slate-200">
                    {documentItems.map((document) => (
                      <div
                        key={document.id}
                        className="grid grid-cols-[minmax(0,1fr)_112px] gap-3 px-5 py-4 transition hover:bg-red-50 md:grid-cols-[1fr_130px_110px_110px_180px] md:items-center"
                      >
