          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_420px] lg:items-start">
            <section className="rounded-3xl border border-red-200 bg-red-50 p-6 shadow-sm sm:p-10">
              ...
              <h1 className="mt-4 max-w-4xl [text-wrap:balance] text-4xl font-black sm:text-5xl tracking-tight text-slate-950 md:text-6xl">
                PFU-avgjørelse er ikke del av redaksjonelt forhåndsløp
              </h1>

              <p className="mt-6 max-w-3xl text-xl leading-9 text-slate-700">
                Denne siden er laget for å registrere PFU-status og PFU-avgjørelse
                etter at en klage er sendt. For journalist og redaksjon bør
                hovedløpet være publiseringsgrunnlag, redaksjonell rapport,
                VVP-risiko og kvalitetssikring før publisering.
              </p>
            ...
            <aside className="grid content-start gap-6">
              ...
              <div className="rounded-3xl bg-slate-950 p-5 text-white shadow-sm sm:p-7">
                ...
                <p className="mt-4 leading-8 text-slate-300">
                  For redaksjoner bør dokumentasjonen brukes til fakta,
            ...
            <div className="mt-8 grid gap-6">
              ...
              <div className="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap">
                ...
                <Link
                  ...
                  className="col-span-2 w-full rounded-2xl border border-red-300 bg-red-50 px-6 py-4 text-center font-black text-red-900 hover:bg-red-50 sm:col-span-1 sm:w-auto"
                >
                  Gå til utredning
                </Link>
