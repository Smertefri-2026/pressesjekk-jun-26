              ...
              <div className="mt-8 grid gap-4">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  <h3 className="mt-2 text-2xl font-black text-slate-950">
                    Saksforside og hovedopplysninger
                  </h3>
                  <p className="mt-3 leading-8 text-slate-700">
                    Første del gjenspeiler saken: hvem saken gjelder, hva
                    medieomtalen handler om, sentrale datoer, status og kort
                    sammendrag.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  <p className="mt-3 leading-8 text-slate-700">
                    Andre del beskriver selve saken i riktig rekkefølge, med
                    hendelser, dokumentasjon, kontakt med redaksjon, PFU-spor og
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  <p className="mt-3 leading-8 text-slate-700">
                    Tredje del samler dokumenter, artikler, e-poster, skjermbilder,
                    PFU-dokumenter og annen dokumentasjon i nummerert og
          ...
          <aside className="grid gap-6">
            ...
            <div className="rounded-3xl bg-slate-950 p-5 text-white shadow-sm sm:p-7">
              ...
              <p className="mt-4 leading-8 text-slate-300">
                Utredningspakken er for saker som krever grundig manuell
                gjennomgang, strukturering og dokumentasjon før videre steg.
              </p>
            </div>
          </aside>
        </div>
